...
description: >
  ...
  accent, the three-step gray text ladder, Helvetica Neue (display/numerals/chrome) + Helvetica Neue (body),
...
colors:
  ...
  text-muted: "#6B6B6B"
  text-light: "#9A9A9A"
  accent-light: "rgba(91, 31, 199, 0.08)"
  accent-medium: "rgba(91, 31, 199, 0.15)"
  border: "rgba(91, 31, 199, 0.2)"
  card-bg: "rgba(91, 31, 199, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  # — reading ramp (Helvetica Neue body + Helvetica Neue chrome) —
  body:    { fontFamily: "Helvetica Neue", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "Helvetica Neue", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "Helvetica Neue", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "Helvetica Neue", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Helvetica Neue, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Helvetica Neue", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Helvetica Neue", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Helvetica Neue", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "Helvetica Neue", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "Helvetica Neue", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "Helvetica Neue", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "Helvetica Neue", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
The voice is two faces in fixed roles: **Helvetica Neue** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **Helvetica Neue** (body, muted gray, line 1.6). Headlines are near-black;
...
- **Helvetica Neue** (display/numerals/chrome) + **Helvetica Neue** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (Helvetica Neue body 0.85cqw muted; Helvetica Neue eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (Helvetica Neue `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body Helvetica Neue 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line Helvetica Neue `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + Helvetica Neue label + muted desc + optional
...
blockquote, cite. **Focal** a Helvetica Neue `blockquote` near-black under a 15%-opacity cobalt
...
Helvetica Neue body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a Helvetica Neue `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body Helvetica Neue 400 muted, line 1.6.
...
- **Type** — Helvetica Neue headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; Helvetica Neue body muted line 1.6; ≥1.4cqw floor.
...
- **Helvetica Neue + Helvetica Neue via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
